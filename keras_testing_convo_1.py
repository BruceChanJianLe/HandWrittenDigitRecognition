...
plt.savefig('accuracy_cnn_dropout.png', bbox_inches='tight')
plt.plot(history_cnn.history['val_acc'])
plt.savefig('validation_accuracy_cnn_dropout.png', bbox_inches='tight')

# Saving the model for future use
cnn.save("trained_cnn_dropout_model.h5")
